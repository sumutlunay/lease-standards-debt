...
| `table6_supplement.py` | `table6_supplement.xlsx` | Table 6 supplement — correlation matrices and untreated-cell score-level counts for each window (4 sheets). Asserts its samples match Table 6's panels |
