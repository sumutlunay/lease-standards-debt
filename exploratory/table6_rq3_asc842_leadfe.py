...
★ LEAD-ARRANGER FE VARIANT (2026-09-02). Identical to code/manuscript/table6_rq3_asc842.py in every
...
same row and column layout. A coefficient that moves between table6_leadfe.xlsx and table6.xlsx moved because of
...
Output: output/tables/table6_leadfe.xlsx  (sheets: Panel A, Panel B, Panel C, Panel D)
"""
...
OUT_FILE  = OUT_DIR / "table6_leadfe.xlsx"
