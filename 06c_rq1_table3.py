"""
06c_rq1_table3.py  →  output/tables/table3.xlsx   (Table 3)

RQ1, single specification for all five dependent variables side by side, formatted to the
manuscript's Table 3 layout. Industry×Year + Borrower + Lender multi-hot FEs, with the five
determinants AND the deal/firm controls, reported as ONE sheet with the five DVs in five columns
ordered ALL, SLB, SYN, OPL, VAR-RES.
...
Presentation (manuscript Table 3):
  ...
  Right-hand side : the 5 determinants + the deal/firm controls (see DETERMINANTS, CONTROLS).
